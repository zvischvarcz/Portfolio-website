    ...
    return (
        <div>
            ...
            <div className="contactWrap">
                ...
                zvischvarcz@gmail.com<img onClick={() => copyTextToClipboard("zvischvarcz@gmail.com")} className="copyIcon" src={copyIcon} alt="copy text" /></label>
                <label>
                    <img src={phoneImg} alt="phone icon"/>
                +44 (0) 7895 052 933<img onClick={() => copyTextToClipboard(+447895052933)} className="copyIcon" src={copyIcon} alt="copy text" /></label>
